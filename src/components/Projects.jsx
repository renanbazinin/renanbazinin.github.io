...
const Projects = () => {
  ...
  const projects = [{
    ...
    short: "🏆 2x Award-Winning AI project presented at AI-ED 2025 (Italy). Won 1st place at ACM SYSTOR 2025 & MTA's annual conference. Transforms video lectures into interactive learning experiences.",
    ...
    link: 'https://the-jar-team.github.io/focus-flow-client-offline-backup/',
    linkGithub: 'https://github.com/The-JAR-Team/focus-flow-client',
    linkDemo: 'https://youtu.be/6DzAMohd6tg', // Replace with your actual demo link
    technologies: ['Python', 'Flask', 'MediaPipe', 'ONNX', 'PostgreSQL', 'Google Gemini API', 'React', 'PyTorch', 'Gunicorn'],
