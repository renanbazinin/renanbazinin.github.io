...
export default function FirstThingsCal() {
  ...
  const storeData = useSelector(store => { return store })
    ...
    useEffect(() => {
      ...
      dispatch({type:"CHANGE-SEC",payload:"FirstThingsCal"})
  ...
  return (
    ...
    frameborder="0"
    scrolling="no"
    src="https://drive.google.com/file/d/1-tSwUpC4sAiYf7bVlRP8ecuPE5UI9tHC/preview">
